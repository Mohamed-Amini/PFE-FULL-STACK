    ...
    <div className='w-full h-ful'>
      ...
      <div className='bg-[#FFFFFF] h-full w-[68%] rounded-3xl px-3 py-2 flex justify-between'>
        <div className='w-[49%] h-full bg-[#41DBA9] rounded-3xl text-white px-3 py-2'>
          ...
          <p className='text-[#FFFFFFappointments={JSON.stringify(appointments)}] font-sans w-[250px] text-lg'>Data obtained for the last 7 days from 5.567 Visitor to 7.525 Visitor.</p>
        </div>
