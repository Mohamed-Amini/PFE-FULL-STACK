...
import images3 from '../../images/Responsive1.png'
...
export default function Sectione1() {
  ...
  return (
    <Cadr>
    <div className='w-full  h-[600px] mt-4 max-[700px]:rounded-3xl max-[700px]:bg-[#1B53F5] rounded-[25px] relative max-[700px]:px-0 section1 max-[700px]:h-[700px] '>
