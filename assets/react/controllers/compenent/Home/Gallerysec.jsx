...
export default function Gallerysec() {
  ...
  return (
    <Cadr>
    <div className='w-full bg-[#FFFFFF] px-10 py-10 rounded-[20px] h-screen relative'>
            <h1 className='font-medium text-3xl'>GALLERY</h1>
            <p className='font-semibold text-3xl absolute top-12 left-96 w-2/4'>Contact us today to experience the same level of professionalism and expertise that has get a complete satisfaction from our clients.</p>
            <div className='w-full pt-28 flex gap-14 mt-32'>
              <div className='w-2/4 flex items-center gap-36'>
                <div className='w-[40%] h-[450px]  rounded-3xl'>
