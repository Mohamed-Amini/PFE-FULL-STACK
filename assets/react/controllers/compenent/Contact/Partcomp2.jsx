...
export default function Partcomp2() {
  ...
  const handleSubmit = (event) => {
    ...
    const firstName = event.target.elements['contact[FName]'].value;
    const lastName = event.target.elements['contact[LName]'].value;
    const email = event.target.elements['contact[email]'].value;
    const phoneNumber = event.target.elements['contact[Phone]'].value;
    const message = event.target.elements['contact[Message]'].value;
