    ...
    <div>
       <div className='mx-auto w-3/4 flex flex-col items-center gap-3 mb-10'>
        ...
        <form action="">
            ...
            <Link to='/Login/forgitPawword' className='text-[#252733] cursor-pointer text-right mt-2 font-medium'>Forgot Password ?</Link>
            </Inputwraper>
            <Submit value='Log In'></Submit>
            <p className='font-semibold text-base text-center mt-4 text-[#5E5E60]'>You dont have an account? <Link to='/Register' className='text-[#1B53F5] cursor-pointer'> Sign Up?</Link></p>
         </form>
    </div>
  )
}
